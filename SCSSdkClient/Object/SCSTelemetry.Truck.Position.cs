...
namespace SCSSdkClient.Object {
    public partial class SCSTelemetry {
        ...
        public class PositionData {
            ...
            ///     <seealso cref="HeadPositionInWorldSpace" />
            /// </summary>
            public FVector HeadPositionInVehicleSpace => Add( Add( Cabin, CabinOffset.Position ), Rotate( CabinOffset.Orientation, HeadPositionInCabinSpace ) );

            /// <summary>
            ///     Head position in the World Space. Head is the Player models (viewable e.g. in camera perspective 2) head.
            /// </summary>
            public DVector HeadPositionInWorldSpace =>
                Add( TruckPosition.Position,
            ...
            /// </summary>
            public DVector CabinPositionInWorlSpace => Add( TruckPosition.Position, Rotate( TruckPosition.Orientation, Cabin ) );

            /// <summary>
            ///     AT THE MOMENT ONLY A TEST
            ///     Hook position of the truck in world space
            /// </summary>
            public DVector HookPositionInWorldSpace => Add( TruckPosition.Position, Rotate( TruckPosition.Orientation, Hook ) );
        }
    }
}